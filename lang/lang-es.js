...
window.translation = {
  titleFull: "Generador de Mapas de Fantasía de Azgaar",
  titleName: "De Azgaar",
  title: "Generador de Mapas de Fantasía",
  version: "v. ",
  loading: "Cargando",
  newMap: "¡Mapa nuevo!",
  layers: "Capas",
  ...
  tools: "Herramientas",
  about: "Sobre mí",
  tipOptionsTrigger: "Haz click para mostrar el panel de opciones. Acceso rápido: Tab",
  tipRegenerate: "Hax click para generar un mapa nuevo. Acceso rápido: F2",
  optionsDragTrigger: "Arrastra para mover el panel de opciones",
  optionsHide: "Haz click para esconder el panel de opciones. Acceso rápido: Tab para cerrar este diálogo o Esc para cerrarlos todos",
  layersTab: "Haz click para cambiar las capas del mapa",
  styleTab: "Haz click para abrir el editor de estilos",
  optionsTab: "Haz click para cambiar las opciones de generación y las opciones de la interfaz",
  toolsTab: "Haz click para abrir el menú de herramientas",
  aboutTab: "Haz click para ver la info del generador"
};

return;
// list of tooltips from init DOM (dynamically added elements are not icluded)
const sourceDataForReference = {
  optionsTrigger: "Haz click para mostrar el panel de opciones. Acceso rápido: Tab",
  NeedToAdd!: "Arrastra para mover el panel de opciones",
  optionsHide: "Haz click para esconder el panel de opciones. Acceso rápido: Tab para cerrar este diálogo o Esc para cerrarlos todos",
  NeedToAdd!: "Selecciona una opción prefedinida para las capas del mapa",
  savePresetButton: "Haz click para guardar las capas visibles como una nueva opción predefinida",
  removePresetButton: "Haz click para borrar la opción predefinida personalizada activa",
  NeedToAdd!: "Haz click para (des)activar una capa, arrastra para subir o bajar una capa. Ctrl + Click para editar el estilo de capa",
  toggleRulers: "Reglas: click para (des)activar, arrastra para mover, click en etiqueta para borrar. Ctrl + click para editar estilo de capa. Acceso rápido: = (igual)",
  toggleScaleBar: "Barra de escala: Click para (des)activar. Ctrl + click para editar estilo. Acceso rápido: - (menos)",
  viewStandard: "Modo de vista estándar que permite editar el mapa",
  viewMesh: "Representación del mapa en 3D. Funciona mejor con mapa de altura. No se puede usar para editar",
  viewGlobe: "Proyectar el mapa en una esfera. No se puede usar para editar",
  NeedToAdd!: "Selecciona un estilo predefinido",
  addStyleButton: "Haz click para guardar el estilo activo como nuevo predefinido",
  removeStyleButton: "Haz click para borrar el estilo predefinido personalizado activo",
  NeedToAdd!: "Selecciona un elemento para editar su estilo",
  styleIsOff: "La capa seleccionada no es visible. Mira los botones arriba para activarla",
  NeedToAdd!: "Haz click y proporciona una URl a una imagen para establecerla como textura",
  styleTextureShiftX: "Mover la textura en el eje X en píxeles",
  styleTextureShiftY: "Mover la textura en el eje Y en píxeles",
  styleGridSizeFriendly: "Distancia entre dos celdas adyacentes en la escala del mapa",
  styleShiftX: "Mover en el eje X en píxeles",
  styleShiftY: "Mover en el eje Y en píxeles",
  styleCompassShiftX: "Mover en el eje X en píxeles",
  styleCompassShiftY: "Mover en el eje Y en píxeles",
  styleInputFont: "Proporciona un link a una declaración @font-face o escribe el nombre de la fuente de Google",
  styleFontAdd: "Añadir una fuente desde otra web",
  styleFontPlus: "Multiplica el tamaño de la fuente por 1.1",
  styleFontMinus: "Multiplica el tamaño de la fuente por 1.1",
  styleRadiusPlus: "Multiplica el radio por 1.1",
  styleRadiusMinus: "Multiplica el radio por 1.1",
  styleIconSizePlus: "Multiplica el tamaño por 1.1",
  styleIconSizeMinus: "Multiplica el tamaño por 1.1",
  NeedToAdd!: "Permitir que el sistema esconda etiquetas si son demasiado pequeñas o grandes en esa escala",
  NeedToAdd!: "Ajustes de la generación de mapas. Genera un mapa nuevo para aplicar los ajustes",
  toggleFullscreen: "Cambia entre tamaño de la pantalla y tamaño inicial del lienzo",
  optionsSeedGenerate: "Haz click para generar un mapa con esta semilla",
  optionsMapHistory: "Mostrar historial de semillas para aplicar una semilla anterior",
  optionsCopySeed: "Copiar semilla del mapa como URL. Solamente producirá el mismo mapa si las opciones son iguales o por defecto",
  NeedToAdd!: "Regenerar nombre del mapa",
  NeedToAdd!: "Ajustes de herramientas que no afectan a los mapas. Los cambios se aplican inmediatamente",
  NeedToAdd!: "Zoom mínimo posible (debe ser > 0)",
  zoomExtentMin: "Zoom mínimo posible (debe ser > 0)",
  NeedToAdd!: "Zoom máximo posible (debe ser > 1)",
  zoomExtentMax: "Zoom máximo posible (debe ser > 1)",
  zoomExtentDefault: "Restablecer zoom por defecto [1, 20]",
  configureWorld: "Haz click para abrir el configurador del mundo y ajustar la posición del mapa sobre el globo, y el clima global",
  optionsReset: "Haz click para reestablecer las opciones por defecto (la página se recargará)",
  editHeightmapButton: "Hax click para abrir el menú de configuración del mapa de altura. Acceso rápido: Shift + H",
  editBiomesButton: "Haz click para abrir el editor de biomas. Acceso rápido: Shift + B",
  editStatesButton: "Haz click para abrir el editor de estados. Acceso rápido: Shift + S",
  editProvincesButton: "Haz click para abrir el editor de provincias. Acceso rápido: Shift + P",
  editDiplomacyButton: "Haz click para abrir el editor de relaciones diplomáticas. Acceso rápido: Shift + D",
  editCulturesButton: "Haz click para abrir el editor de culturas. Acceso rápido: Shift + C",
  editNamesBaseButton: "Haz click para abrir el editor de la base de nombres. Acceso rápido: Shift + N",
  editZonesButton: "Haz click para abrir el editor de zonas. Acceso rápido: Shift + Z",
  editReligions: "Haz click para abrir el editor de religiones. Acceso rápido: Shift + R",
  editUnitsButton: "Haz click para abrir el editor de unidades. Acceso rápido: Shift + Q",
  editNotesButton: "Haz click para abrir el editor de notas. Acceso rápido: Shift + O",
  overviewBurgsButton: "Haz click para abrir la lista de urbes. Acceso rápido: Shift + T",
  overviewRiversButton: "Haz click para abrir la lista de ríos. Acceso rápido: Shift + V",
  overviewMilitaryButton: "Haz click para abrir la lista de fuerzas militares. Acceso rápido: Shift + M",
  overviewCellsButton: "Haz click para ver los detalles de las celdas. Acceso rápido: Shift + E",
  regenerateStateLabels: "Haz click para actualizar la posición de las etiquetas de estados basado en bordes actuales",
